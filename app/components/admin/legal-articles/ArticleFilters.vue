    ...
    <div class="bg-card rounded-lg border p-4">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div class="md:col-span-2">
                ...
                <Input v-model="localFilters.keyword" placeholder="搜索内容、标题..." class="w-full" />
            </div>
            <!-- 条文类型 -->
            <div>
