  ...
  <Dialog v-model:open="isOpen">
    <DialogContent class="sm:max-w-md">
      <DialogHeader>
        ...
        <DialogDescription> 设置一个密码来保护您的加密密钥。此密码用于加密您的私钥，请妥善保管。 </DialogDescription>
      </DialogHeader>
...
const handleSubmit = async () => {
  ...
  try {
    ...
    // 保存到服务器
    const success = await encryptionStore.saveConfig(keyPair.recipient, encryptedIdentity);
