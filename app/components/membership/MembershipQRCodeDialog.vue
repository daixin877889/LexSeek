<template>
    <!-- 会员支付弹框（基于通用组件，支持扫码和 JSAPI） -->
    <PaymentQRCodeDialog :open="open" :qr-code-url="qrCodeUrl" :loading="loading" :paid="paid" :use-jsapi="useJsapi"
        :jsapi-params="jsapiParams" title="请使用微信扫码购买" description="打开微信扫一扫，立即购买会员" success-description="会员已开通，感谢您的支持！"
        success-message="正在为您开通会员..." @update:open="emit('update:open', $event)" @close="emit('close')"
