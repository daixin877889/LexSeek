            ...
            <div class="space-y-4">
              ...
              <div>
                ...
                <div class="flex items-center space-x-2 mt-1">
                  ...
                  <Button size="sm" class="bg-gradient-brand-button text-white" @click="copyInviteLink" :disabled="!inviteLink">
              ...
              <div class="flex flex-col items-center space-y-2">
                ...
                <div class="flex gap-2">
                  <Button size="sm" class="bg-gradient-brand-button text-white" @click="downloadQRCode" :disabled="!qrCodeGenerated">
                    <Download class="h-4 w-4 mr-1" />
                    下载二维码
                  </Button>
                  <Button size="sm" class="bg-gradient-brand-button text-white" @click="regenerateQRCode">
      ...
      <TabsContent value="invite-records" class="mt-6">
        <div class="border rounded-lg p-6 bg-card">
          <div class="flex items-center justify-between mb-4">
            ...
            <Button size="sm" class="bg-gradient-brand-button text-white" @click="fetchInvitees" :disabled="loading">
