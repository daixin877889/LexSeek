  ...
  <div class="bg-card rounded-lg border p-6">
    ...
    <div v-else class="space-y-6">
      ...
      <div class="flex items-center justify-between p-4 border rounded-lg">
        <div class="flex items-center gap-3">
          <div :class="['w-10 h-10 rounded-full flex items-center justify-center', encryptionStore.isUnlocked ? 'bg-green-100 dark:bg-green-900/50' : 'bg-amber-100 dark:bg-amber-900/50']">
            <UnlockIcon v-if="encryptionStore.isUnlocked" class="h-5 w-5 text-green-600 dark:text-green-400" />
      ...
      <div class="p-4 border rounded-lg">
        <div class="flex items-center justify-between">
          <div class="flex items-center gap-3">
            <div :class="['w-10 h-10 rounded-full flex items-center justify-center', encryptionStore.hasRecoveryKey ? 'bg-green-100 dark:bg-green-900/50' : 'bg-muted']">
              <HelpCircleIcon :class="['h-5 w-5', encryptionStore.hasRecoveryKey ? 'text-green-600 dark:text-green-400' : 'text-muted-foreground']" />
            </div>
            <div>
          ...
          <div class="flex gap-2">
            ...
            <Button v-if="encryptionStore.hasRecoveryKey" variant="outline" size="sm" @click="showRecoverDialog = true"> 忘记密码 </Button>
          </div>
        </div>
      </div>
    ...
    <EncryptionChangePasswordDialog v-model:open="showChangePasswordDialog" @success="handleChangePasswordSuccess" />

    <EncryptionRecoveryKeyDialog v-model:open="showRecoveryKeyDialog" :mode="recoveryKeyMode" @success="handleRecoveryKeySuccess" />
  </div>
</template>
