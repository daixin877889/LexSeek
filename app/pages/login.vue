        ...
        <div class="bg-card border rounded-lg p-6 shadow-sm">
          <form @submit.prevent="handleLogin" class="space-y-5">
            <div>
              ...
              <input id="phone" v-model="phone" type="tel" autocomplete="tel" required
            ...
            <div>
              <Button type="submit" :disabled="authStore.loading"
                class="h-11 w-full text-base flex justify-center items-center py-2.5 bg-primary text-primary-foreground rounded-md hover:bg-primary/90 transition-colors font-medium">
