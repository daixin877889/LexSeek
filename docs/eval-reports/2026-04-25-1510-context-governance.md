...
- 跑批时间：2026-04-25T15:10:03+08:00
- Commit：42c3ca0a
- 总耗时：107.3s
...
| 指标 | 值 | 阈值 | 级别 | 状态 |
|---|---|---|---|---|
| systemPromptTokensAvg | 909 | < 4000 | WARN | [PASS] |
...
| q-profile-02 | profile | 本案的二审法院是哪个？ |  | 0/1 | - | 0.0s | [FAIL] |
...
| q-memory-01 | memory | 我们之前确定的争议金额是多少？ |  | 0/2 | - | 0.0s | [FAIL] |
...
| q-analysis-05 | analysis | 版本切换前后这个模块的结论有什么变化？（注：本提问由 run... |  | 0/1 | - | 0.0s | [FAIL] |
| q-cross-01 | cross | 请综合案件基本信息、所有证据、之前的讨论笔记，给出一个 3 ... |  | - | - | 0.0s | [FAIL] |
| q-cross-02 | cross | 基于已有材料和我们的讨论，下一步应该做什么？ |  | - | - | 0.1s | [FAIL] |
| q-cross-03 | cross | 当事人的偏好如何影响分析结论？ |  | - | - | 0.0s | [FAIL] |
| q-cross-04 | cross | 一审审判长姓名 + 当前争议金额 + 风险结论倾向？ |  | 0/3 | - | 0.0s | [FAIL] |
