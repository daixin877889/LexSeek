...
INSERT INTO "public"."nodes" ("id", "name", "title", "description", "type", "priority", "model_id", "tools", "group_id", "status", "created_at", "updated_at", "deleted_at") VALUES (5, 'caseMain', '案件分析主 Agent', '案件分析的主 Agent，负责协调子 Agent 完成任务', 'agent', 100, 2, '["process_materials", "extract_case_info", "search_case_materials", "search_law", "reserve_points", "confirm_points", "rollback_points"]', 1, 1, '2026-03-21 11:23:17.357+08', '2026-03-21 11:23:17.357+08', NULL);
INSERT INTO "public"."nodes" ("id", "name", "title", "description", "type", "priority", "model_id", "tools", "group_id", "status", "created_at", "updated_at", "deleted_at") VALUES (6, 'summary', '生成案件概要', '根据案情生成案情概要。', 'analysis', 100, 2, '["search_case_materials", "search_law", "process_materials", "extract_case_info", "reserve_points", "confirm_points", "rollback_points"]', NULL, 1, '2026-03-23 11:16:08.982+08', '2026-03-23 11:17:36.654+08', NULL);
INSERT INTO "public"."nodes" ("id", "name", "title", "description", "type", "priority", "model_id", "tools", "group_id", "status", "created_at", "updated_at", "deleted_at") VALUES (7, 'chronicle', '提取案件大事记', '提取案件的大事记表格', 'analysis', 300, 2, '["rollback_points", "confirm_points", "reserve_points", "search_case_materials", "search_law", "process_materials", "extract_case_info"]', NULL, 1, '2026-03-23 11:17:16.49+08', '2026-03-23 11:26:02.068+08', NULL);
INSERT INTO "public"."nodes" ("id", "name", "title", "description", "type", "priority", "model_id", "tools", "group_id", "status", "created_at", "updated_at", "deleted_at") VALUES (8, 'claim', '预分析案件请求权', '根据资料分析案件的请求权', 'analysis', 400, 2, '["search_case_materials", "search_law", "process_materials", "extract_case_info", "reserve_points", "confirm_points", "rollback_points"]', NULL, 1, '2026-03-23 11:20:12.923+08', '2026-03-23 11:25:49.276+08', NULL);
INSERT INTO "public"."nodes" ("id", "name", "title", "description", "type", "priority", "model_id", "tools", "group_id", "status", "created_at", "updated_at", "deleted_at") VALUES (9, 'trend', '判决趋势预测', '法律合理性审查和判决趋势预测', 'analysis', 500, 2, '["search_case_materials", "search_law", "extract_case_info", "reserve_points", "confirm_points", "process_materials"]', NULL, 1, '2026-03-23 11:22:54.866+08', '2026-03-23 11:25:36.114+08', NULL);
INSERT INTO "public"."nodes" ("id", "name", "title", "description", "type", "priority", "model_id", "tools", "group_id", "status", "created_at", "updated_at", "deleted_at") VALUES (10, 'cause', '预选案由', '根据的请求权确定案由', 'analysis', 600, 2, '["search_law", "search_case_materials", "process_materials", "extract_case_info", "reserve_points", "confirm_points", "rollback_points"]', NULL, 1, '2026-03-23 11:23:47.941+08', '2026-03-23 11:23:47.941+08', NULL);
INSERT INTO "public"."nodes" ("id", "name", "title", "description", "type", "priority", "model_id", "tools", "group_id", "status", "created_at", "updated_at", "deleted_at") VALUES (11, 'defense', '抗辩分析及应对策略预测', '根据请求权生成抗辩分析及应对策略', 'analysis', 700, 2, '["search_case_materials", "search_law", "process_materials", "extract_case_info", "reserve_points", "confirm_points", "rollback_points"]', NULL, 1, '2026-03-23 11:24:30.281+08', '2026-03-23 11:24:30.281+08', NULL);
INSERT INTO "public"."nodes" ("id", "name", "title", "description", "type", "priority", "model_id", "tools", "group_id", "status", "created_at", "updated_at", "deleted_at") VALUES (12, 'evidence', '证据清单预梳理', '证据清单预梳理', 'analysis', 800, 2, '["search_case_materials", "search_law", "process_materials", "extract_case_info", "reserve_points", "confirm_points", "rollback_points"]', NULL, 1, '2026-03-23 11:25:27.771+08', '2026-03-23 11:25:27.771+08', NULL);
