...
INSERT INTO "public"."routers" ("id", "name", "title", "description", "path", "is_menu", "parent_id", "icon", "group_id", "sort", "menu_group", "menu_group_sort", "created_at", "updated_at", "deleted_at") VALUES (88, 'dashboard-assistant-chat', '通用问答', '无案件上下文的通用问答对话入口', '/dashboard/assistant', 't', NULL, 'lucideIcons.MessageSquareIcon', 1, 4, NULL, 0, '2026-04-17 15:32:55.038+08', '2026-04-17 15:32:55.038+08', NULL);
...
INSERT INTO "public"."api_permissions" ("id", "path", "method", "name", "description", "is_public", "group_id", "status", "created_at", "updated_at", "deleted_at") VALUES (370, '/api/v1/admin/nodes/:id/prompts', 'PATCH', 'PATCH admin / nodes / [id] / prompts', NULL, 'f', NULL, 1, '2026-05-11 00:00:25.37+08', '2026-05-11 00:00:25.37+08', NULL);
INSERT INTO "public"."api_permissions" ("id", "path", "method", "name", "description", "is_public", "group_id", "status", "created_at", "updated_at", "deleted_at") VALUES (371, '/api/v1/admin/nodes/:id/prompts/preview', 'GET', 'GET admin / nodes / [id] / prompts / preview', NULL, 'f', NULL, 1, '2026-05-11 00:00:25.37+08', '2026-05-11 00:00:25.37+08', NULL);
INSERT INTO "public"."api_permissions" ("id", "path", "method", "name", "description", "is_public", "group_id", "status", "created_at", "updated_at", "deleted_at") VALUES (372, '/api/v1/admin/prompts/preview-bundle', 'POST', 'POST admin / prompts / preview bundle', NULL, 'f', NULL, 1, '2026-05-11 00:00:25.37+08', '2026-05-11 00:00:25.37+08', NULL);
