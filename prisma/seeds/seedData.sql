...
INSERT INTO "public"."point_consumption_items" ("id", "key", "group", "name", "description", "unit", "point_amount", "status", "created_at", "updated_at", "deleted_at", "discount", "billing_mode", "display_name") VALUES (2, 'asr_transcribe', 'material', '语音识别转录', '语音识别转录', '分钟', 1, 1, '2026-03-16 20:28:50.425184+08', '2026-03-16 20:28:50.425184+08', NULL, '0.30', 2, '录音转文字');
INSERT INTO "public"."point_consumption_items" ("id", "key", "group", "name", "description", "unit", "point_amount", "status", "created_at", "updated_at", "deleted_at", "discount", "billing_mode", "display_name") VALUES (3, 'ocr_recognize', 'material', '图片文字识别', '图片文字识别', '张', 1, 0, '2026-03-16 20:28:50.425548+08', '2026-03-16 20:28:50.425548+08', NULL, '1.00', 2, '图片文字识别');
INSERT INTO "public"."point_consumption_items" ("id", "key", "group", "name", "description", "unit", "point_amount", "status", "created_at", "updated_at", "deleted_at", "discount", "billing_mode", "display_name") VALUES (4, 'title', 'analysisModules', '提取案件标题', '提取案件标题', '次', 0, 0, '2026-03-16 20:28:50.425907+08', '2026-03-16 20:28:50.425907+08', NULL, '1.00', 2, NULL);
INSERT INTO "public"."point_consumption_items" ("id", "key", "group", "name", "description", "unit", "point_amount", "status", "created_at", "updated_at", "deleted_at", "discount", "billing_mode", "display_name") VALUES (5, 'summary', 'analysisModules', '生成案件概要', '生成案件概要', '次', 3, 0, '2026-03-16 20:28:50.426298+08', '2026-03-16 20:28:50.426298+08', NULL, '1.00', 2, NULL);
INSERT INTO "public"."point_consumption_items" ("id", "key", "group", "name", "description", "unit", "point_amount", "status", "created_at", "updated_at", "deleted_at", "discount", "billing_mode", "display_name") VALUES (6, 'chronicle', 'analysisModules', '提取案件大事记', '提取案件大事记', '次', 2, 0, '2026-03-16 20:28:50.426727+08', '2026-03-16 20:28:50.426727+08', NULL, '1.00', 2, NULL);
INSERT INTO "public"."point_consumption_items" ("id", "key", "group", "name", "description", "unit", "point_amount", "status", "created_at", "updated_at", "deleted_at", "discount", "billing_mode", "display_name") VALUES (7, 'claim', 'analysisModules', '预分析案件请求权', '预分析案件请求权', '次', 9, 0, '2026-03-16 20:28:50.427088+08', '2026-03-16 20:28:50.427088+08', NULL, '0.70', 2, NULL);
INSERT INTO "public"."point_consumption_items" ("id", "key", "group", "name", "description", "unit", "point_amount", "status", "created_at", "updated_at", "deleted_at", "discount", "billing_mode", "display_name") VALUES (8, 'cause', 'analysisModules', '预选案由', '预选案由', '次', 9, 0, '2026-03-16 20:28:50.427468+08', '2026-03-16 20:28:50.427468+08', NULL, '0.70', 2, NULL);
INSERT INTO "public"."point_consumption_items" ("id", "key", "group", "name", "description", "unit", "point_amount", "status", "created_at", "updated_at", "deleted_at", "discount", "billing_mode", "display_name") VALUES (9, 'trend', 'analysisModules', '法律合理性审查和判决趋势预测', '法律合理性审查和判决趋势预测', '次', 9, 0, '2026-03-16 20:28:50.427855+08', '2026-03-16 20:28:50.427855+08', NULL, '0.70', 2, NULL);
INSERT INTO "public"."point_consumption_items" ("id", "key", "group", "name", "description", "unit", "point_amount", "status", "created_at", "updated_at", "deleted_at", "discount", "billing_mode", "display_name") VALUES (10, 'defense', 'analysisModules', '抗辩分析及应对策略预测', '抗辩分析及应对策略预测', '次', 5, 0, '2026-03-16 20:28:50.428246+08', '2026-03-16 20:28:50.428246+08', NULL, '1.00', 2, NULL);
INSERT INTO "public"."point_consumption_items" ("id", "key", "group", "name", "description", "unit", "point_amount", "status", "created_at", "updated_at", "deleted_at", "discount", "billing_mode", "display_name") VALUES (11, 'evidence', 'analysisModules', '证据清单预梳理', '证据清单预梳理', '次', 7, 0, '2026-03-16 20:28:50.428623+08', '2026-03-16 20:28:50.428623+08', NULL, '0.70', 2, NULL);
INSERT INTO "public"."point_consumption_items" ("id", "key", "group", "name", "description", "unit", "point_amount", "status", "created_at", "updated_at", "deleted_at", "discount", "billing_mode", "display_name") VALUES (12, 'case_analysis_token', 'agentToken', '案件分析词元消耗（已废弃）', '保留供历史扣费记录展示，新计费走 case_analysis_init / case_module_chat / case_main_chat', '千tokens', 1, 0, '2026-03-26 00:00:00+08', '2026-05-20 00:00:00+08', NULL, '0.03', 1, '案件智能分析');
INSERT INTO "public"."point_consumption_items" ("id", "key", "group", "name", "description", "unit", "point_amount", "status", "created_at", "updated_at", "deleted_at", "discount", "billing_mode", "display_name") VALUES (13, 'document_draft_token', 'agentToken', '文书生成词元消耗', '文书生成按模型 token 用量扣减积分', '千tokens', 1, 1, '2026-04-17 10:00:00+08', '2026-04-21 00:03:22.141+08', NULL, '0.10', 1, 'AI 文书起草');
INSERT INTO "public"."point_consumption_items" ("id", "key", "group", "name", "description", "unit", "point_amount", "status", "created_at", "updated_at", "deleted_at", "discount", "billing_mode", "display_name") VALUES (14, 'contract_review_token', 'agentToken', '合同审查词元消耗', '合同审查按模型 token 用量扣减积分', '千tokens', 1, 1, '2026-04-18 10:00:00+08', '2026-04-22 11:41:50.071+08', NULL, '0.10', 1, '合同智能审查');
INSERT INTO "public"."point_consumption_items" ("id", "key", "group", "name", "description", "unit", "point_amount", "status", "created_at", "updated_at", "deleted_at", "discount", "billing_mode", "display_name") VALUES (15, 'assistant_token', 'agentToken', '通用问答词元消耗', '通用问答词按模型 token 用量扣减积分', '千tokens', 1, 1, '2026-04-22 11:41:31.823+08', '2026-04-22 11:42:04.801+08', NULL, '0.10', 1, 'AI 法律问答');
INSERT INTO "public"."point_consumption_items" ("id", "key", "group", "name", "description", "unit", "point_amount", "status", "created_at", "updated_at", "deleted_at", "discount", "billing_mode", "display_name") VALUES (16, 'summary_generate', 'ai', '文件智能摘要', '文件上传后自动生成内容摘要', '千tokens', 1, 0, '2026-05-19 00:00:00+08', '2026-05-19 00:00:00+08', NULL, '0.10', 1, '文件智能摘要');
INSERT INTO "public"."point_consumption_items" ("id", "key", "group", "name", "description", "unit", "point_amount", "status", "created_at", "updated_at", "deleted_at", "discount", "billing_mode", "display_name") VALUES (17, 'memory_extract', 'ai', '案件记忆整理', '对话结束后自动提取并整理案件关键事实', '千tokens', 1, 0, '2026-05-19 00:00:00+08', '2026-05-19 00:00:00+08', NULL, '0.10', 1, '案件记忆整理');
INSERT INTO "public"."point_consumption_items" ("id", "key", "group", "name", "description", "unit", "point_amount", "status", "created_at", "updated_at", "deleted_at", "discount", "billing_mode", "display_name") VALUES (18, 'case_analysis_init', 'agentToken', '案件初始化分析词元消耗', '案件初始化分析按模型 token 用量扣减积分', '千tokens', 1, 1, '2026-05-20 00:00:00+08', '2026-05-20 00:00:00+08', NULL, '0.03', 1, '案件初始化分析');
INSERT INTO "public"."point_consumption_items" ("id", "key", "group", "name", "description", "unit", "point_amount", "status", "created_at", "updated_at", "deleted_at", "discount", "billing_mode", "display_name") VALUES (19, 'case_module_chat', 'agentToken', '案件模块对话词元消耗', '案件分析模块对话按模型 token 用量扣减积分', '千tokens', 1, 1, '2026-05-20 00:00:00+08', '2026-05-20 00:00:00+08', NULL, '0.03', 1, '案件模块对话');
INSERT INTO "public"."point_consumption_items" ("id", "key", "group", "name", "description", "unit", "point_amount", "status", "created_at", "updated_at", "deleted_at", "discount", "billing_mode", "display_name") VALUES (20, 'case_main_chat', 'agentToken', '小索对话词元消耗', '案件内小索对话（含子代理调用）按模型 token 用量扣减积分', '千tokens', 1, 1, '2026-05-20 00:00:00+08', '2026-05-20 00:00:00+08', NULL, '0.03', 1, '小索对话');
