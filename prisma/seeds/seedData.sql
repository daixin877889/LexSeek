...
-- 模型
INSERT INTO "public"."models" ("id", "provider_id", "name", "display_name", "model_type", "sdk_type", "model_version", "context_window", "dimensions", "batch_size", "is_default", "status", "priority", "input_cost_per_million_tokens", "output_cost_per_million_tokens", "created_at", "updated_at", "deleted_at") VALUES (1, 1, 'deepseek-chat', 'DeepSeek V3', 'chat', 'deepseek', NULL, NULL, NULL, NULL, 't', 1, 10, NULL, NULL, '2026-01-05 15:18:33+08', '2026-01-16 02:58:49.449+08', NULL);
INSERT INTO "public"."models" ("id", "provider_id", "name", "display_name", "model_type", "sdk_type", "model_version", "context_window", "dimensions", "batch_size", "is_default", "status", "priority", "input_cost_per_million_tokens", "output_cost_per_million_tokens", "created_at", "updated_at", "deleted_at") VALUES (2, 1, 'deepseek-reasoner', 'DeepSeek R1', 'chat', 'deepseek', NULL, NULL, NULL, NULL, 'f', 1, 20, NULL, NULL, '2026-01-05 15:18:33+08', '2026-01-16 02:57:41.417+08', NULL);
...
INSERT INTO "public"."models" ("id", "provider_id", "name", "display_name", "model_type", "sdk_type", "model_version", "context_window", "dimensions", "batch_size", "is_default", "status", "priority", "input_cost_per_million_tokens", "output_cost_per_million_tokens", "created_at", "updated_at", "deleted_at") VALUES (17, 9, 'qwen3-rerank', 'Qwen3 Rerank', 'rerank', 'openai', NULL, NULL, NULL, NULL, 't', 1, 10, 0.5, NULL, '2026-04-09 10:00:00+08', '2026-04-09 10:00:00+08', NULL);
