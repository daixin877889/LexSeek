...
INSERT INTO "public"."api_permissions" ("id", "path", "method", "name", "description", "is_public", "group_id", "status", "created_at", "updated_at", "deleted_at") VALUES (213, '/api/v1/case/:caseId', 'GET', 'GET case / [caseId]', NULL, 'f', NULL, 1, '2026-04-01 23:40:42.29+08', '2026-04-01 23:40:42.29+08', NULL);
INSERT INTO "public"."api_permissions" ("id", "path", "method", "name", "description", "is_public", "group_id", "status", "created_at", "updated_at", "deleted_at") VALUES (214, '/api/v1/case/:caseId', 'PUT', 'PUT case / [caseId]', NULL, 'f', NULL, 1, '2026-04-01 23:40:42.291+08', '2026-04-01 23:40:42.291+08', NULL);
INSERT INTO "public"."api_permissions" ("id", "path", "method", "name", "description", "is_public", "group_id", "status", "created_at", "updated_at", "deleted_at") VALUES (215, '/api/v1/case/[caseId]/materials', 'GET', 'GET case / [caseId] / materials', NULL, 'f', NULL, 1, '2026-04-01 23:40:42.291+08', '2026-04-01 23:40:42.291+08', NULL);
INSERT INTO "public"."api_permissions" ("id", "path", "method", "name", "description", "is_public", "group_id", "status", "created_at", "updated_at", "deleted_at") VALUES (216, '/api/v1/case/analysis/agents', 'POST', 'POST case / analysis / agents', NULL, 'f', NULL, 1, '2026-04-01 23:40:42.292+08', '2026-04-01 23:40:42.292+08', NULL);
INSERT INTO "public"."api_permissions" ("id", "path", "method", "name", "description", "is_public", "group_id", "status", "created_at", "updated_at", "deleted_at") VALUES (217, '/api/v1/case/analysis/chat', 'POST', 'POST case / analysis / chat', NULL, 'f', NULL, 1, '2026-04-01 23:40:42.293+08', '2026-04-01 23:40:42.293+08', NULL);
INSERT INTO "public"."api_permissions" ("id", "path", "method", "name", "description", "is_public", "group_id", "status", "created_at", "updated_at", "deleted_at") VALUES (218, '/api/v1/case/analysis/runs/:sessionId', 'GET', 'GET case / analysis / runs / [sessionId]', NULL, 'f', NULL, 1, '2026-04-01 23:40:42.294+08', '2026-04-01 23:40:42.294+08', NULL);
INSERT INTO "public"."api_permissions" ("id", "path", "method", "name", "description", "is_public", "group_id", "status", "created_at", "updated_at", "deleted_at") VALUES (219, '/api/v1/case/analysis/runs/cancel/:runId', 'POST', 'POST case / analysis / runs / cancel / [runId]', NULL, 'f', NULL, 1, '2026-04-01 23:40:42.295+08', '2026-04-01 23:40:42.295+08', NULL);
INSERT INTO "public"."api_permissions" ("id", "path", "method", "name", "description", "is_public", "group_id", "status", "created_at", "updated_at", "deleted_at") VALUES (220, '/api/v1/case/analysis/runs/current/:sessionId', 'GET', 'GET case / analysis / runs / current / [sessionId]', NULL, 'f', NULL, 1, '2026-04-01 23:40:42.297+08', '2026-04-01 23:40:42.297+08', NULL);
INSERT INTO "public"."api_permissions" ("id", "path", "method", "name", "description", "is_public", "group_id", "status", "created_at", "updated_at", "deleted_at") VALUES (221, '/api/v1/case/analysis/stream', 'POST', 'POST case / analysis / stream', NULL, 'f', NULL, 1, '2026-04-01 23:40:42.298+08', '2026-04-01 23:40:42.298+08', NULL);
INSERT INTO "public"."api_permissions" ("id", "path", "method", "name", "description", "is_public", "group_id", "status", "created_at", "updated_at", "deleted_at") VALUES (222, '/api/v1/case/analysis/stream/:sessionId', 'POST', 'POST case / analysis / stream / [sessionId]', NULL, 'f', NULL, 1, '2026-04-01 23:40:42.302+08', '2026-04-01 23:40:42.302+08', NULL);
INSERT INTO "public"."api_permissions" ("id", "path", "method", "name", "description", "is_public", "group_id", "status", "created_at", "updated_at", "deleted_at") VALUES (223, '/api/v1/case/analysis/thread/:sessionId', 'GET', 'GET case / analysis / thread / [sessionId]', NULL, 'f', NULL, 1, '2026-04-01 23:40:42.303+08', '2026-04-01 23:40:42.303+08', NULL);
INSERT INTO "public"."api_permissions" ("id", "path", "method", "name", "description", "is_public", "group_id", "status", "created_at", "updated_at", "deleted_at") VALUES (224, '/api/v1/case/analysis/versions/:caseId', 'GET', 'GET case / analysis / versions / [caseId]', NULL, 'f', NULL, 1, '2026-04-01 23:40:42.308+08', '2026-04-01 23:40:42.308+08', NULL);
INSERT INTO "public"."api_permissions" ("id", "path", "method", "name", "description", "is_public", "group_id", "status", "created_at", "updated_at", "deleted_at") VALUES (225, '/api/v1/case/analysis/versions/activate/:analysisId', 'POST', 'POST case / analysis / versions / activate / [analysisId]', NULL, 'f', NULL, 1, '2026-04-01 23:40:42.31+08', '2026-04-01 23:40:42.31+08', NULL);
INSERT INTO "public"."api_permissions" ("id", "path", "method", "name", "description", "is_public", "group_id", "status", "created_at", "updated_at", "deleted_at") VALUES (226, '/api/v1/case/create', 'POST', 'POST case / create', NULL, 'f', NULL, 1, '2026-04-01 23:40:42.31+08', '2026-04-01 23:40:42.31+08', NULL);
INSERT INTO "public"."api_permissions" ("id", "path", "method", "name", "description", "is_public", "group_id", "status", "created_at", "updated_at", "deleted_at") VALUES (227, '/api/v1/case/extract', 'POST', 'POST case / extract', NULL, 'f', NULL, 1, '2026-04-01 23:40:42.311+08', '2026-04-01 23:40:42.311+08', NULL);
INSERT INTO "public"."api_permissions" ("id", "path", "method", "name", "description", "is_public", "group_id", "status", "created_at", "updated_at", "deleted_at") VALUES (228, '/api/v1/case/init-analysis', 'POST', 'POST case / init analysis', NULL, 'f', NULL, 1, '2026-04-01 23:40:42.312+08', '2026-04-01 23:40:42.312+08', NULL);
INSERT INTO "public"."api_permissions" ("id", "path", "method", "name", "description", "is_public", "group_id", "status", "created_at", "updated_at", "deleted_at") VALUES (229, '/api/v1/case/init-analysis-status/:caseId', 'GET', 'GET case / init analysis status / [caseId]', NULL, 'f', NULL, 1, '2026-04-01 23:40:42.313+08', '2026-04-01 23:40:42.313+08', NULL);
INSERT INTO "public"."api_permissions" ("id", "path", "method", "name", "description", "is_public", "group_id", "status", "created_at", "updated_at", "deleted_at") VALUES (230, '/api/v1/case/materials/:caseId', 'POST', 'POST case / materials / [caseId]', NULL, 'f', NULL, 1, '2026-04-01 23:40:42.314+08', '2026-04-01 23:40:42.314+08', NULL);
INSERT INTO "public"."api_permissions" ("id", "path", "method", "name", "description", "is_public", "group_id", "status", "created_at", "updated_at", "deleted_at") VALUES (231, '/api/v1/case/materials/delete/:caseId', 'DELETE', 'DELETE case / materials / delete / [caseId]', NULL, 'f', NULL, 1, '2026-04-01 23:40:42.315+08', '2026-04-01 23:40:42.315+08', NULL);
INSERT INTO "public"."api_permissions" ("id", "path", "method", "name", "description", "is_public", "group_id", "status", "created_at", "updated_at", "deleted_at") VALUES (232, '/api/v1/case/resume/:sessionId', 'POST', 'POST case / resume / [sessionId]', NULL, 'f', NULL, 1, '2026-04-01 23:40:42.316+08', '2026-04-01 23:40:42.316+08', NULL);
INSERT INTO "public"."api_permissions" ("id", "path", "method", "name", "description", "is_public", "group_id", "status", "created_at", "updated_at", "deleted_at") VALUES (233, '/api/v1/case/session/:sessionId', 'GET', 'GET case / session / [sessionId]', NULL, 'f', NULL, 1, '2026-04-01 23:40:42.317+08', '2026-04-01 23:40:42.317+08', NULL);
INSERT INTO "public"."api_permissions" ("id", "path", "method", "name", "description", "is_public", "group_id", "status", "created_at", "updated_at", "deleted_at") VALUES (234, '/api/v1/case/state/:sessionId', 'GET', 'GET case / state / [sessionId]', NULL, 'f', NULL, 1, '2026-04-01 23:40:42.318+08', '2026-04-01 23:40:42.318+08', NULL);
...
INSERT INTO "public"."api_permissions" ("id", "path", "method", "name", "description", "is_public", "group_id", "status", "created_at", "updated_at", "deleted_at") VALUES (266, '/api/v1/case/analysis/init-session', 'POST', 'POST case / analysis / init session', NULL, 'f', NULL, 1, '2026-04-16 15:47:35.267+08', '2026-04-16 15:47:35.267+08', NULL);
INSERT INTO "public"."api_permissions" ("id", "path", "method", "name", "description", "is_public", "group_id", "status", "created_at", "updated_at", "deleted_at") VALUES (267, '/api/v1/case/analysis/module-session', 'POST', 'POST case / analysis / module session', NULL, 'f', NULL, 1, '2026-04-16 15:47:35.286+08', '2026-04-16 15:47:35.286+08', NULL);
INSERT INTO "public"."api_permissions" ("id", "path", "method", "name", "description", "is_public", "group_id", "status", "created_at", "updated_at", "deleted_at") VALUES (268, '/api/v1/case/analysis/module-session/:sessionId', 'DELETE', 'DELETE case / analysis / module session / [sessionId]', NULL, 'f', NULL, 1, '2026-04-16 15:47:35.287+08', '2026-04-16 15:47:35.287+08', NULL);
INSERT INTO "public"."api_permissions" ("id", "path", "method", "name", "description", "is_public", "group_id", "status", "created_at", "updated_at", "deleted_at") VALUES (269, '/api/v1/case/analysis/module-sessions', 'GET', 'GET case / analysis / module sessions', NULL, 'f', NULL, 1, '2026-04-16 15:47:35.288+08', '2026-04-16 15:47:35.288+08', NULL);
INSERT INTO "public"."api_permissions" ("id", "path", "method", "name", "description", "is_public", "group_id", "status", "created_at", "updated_at", "deleted_at") VALUES (270, '/api/v1/case/analysis/session/rename/:sessionId', 'PATCH', 'PATCH case / analysis / session / rename / [sessionId]', NULL, 'f', NULL, 1, '2026-04-16 15:47:35.289+08', '2026-04-16 15:47:35.289+08', NULL);
INSERT INTO "public"."api_permissions" ("id", "path", "method", "name", "description", "is_public", "group_id", "status", "created_at", "updated_at", "deleted_at") VALUES (271, '/api/v1/case/analysis/xiaosuo-session', 'POST', 'POST case / analysis / xiaosuo session', NULL, 'f', NULL, 1, '2026-04-16 15:47:35.29+08', '2026-04-16 15:47:35.29+08', NULL);
INSERT INTO "public"."api_permissions" ("id", "path", "method", "name", "description", "is_public", "group_id", "status", "created_at", "updated_at", "deleted_at") VALUES (272, '/api/v1/case/analysis/xiaosuo-session/:sessionId', 'DELETE', 'DELETE case / analysis / xiaosuo session / [sessionId]', NULL, 'f', NULL, 1, '2026-04-16 15:47:35.291+08', '2026-04-16 15:47:35.291+08', NULL);
INSERT INTO "public"."api_permissions" ("id", "path", "method", "name", "description", "is_public", "group_id", "status", "created_at", "updated_at", "deleted_at") VALUES (273, '/api/v1/case/analysis/xiaosuo-sessions', 'GET', 'GET case / analysis / xiaosuo sessions', NULL, 'f', NULL, 1, '2026-04-16 15:47:35.292+08', '2026-04-16 15:47:35.292+08', NULL);
...
4. **“原文概念锁定”原则**：在处理所有信息时，你必须严格遵守此原则：
   ...
   - **保持概念原貌**：你必须始终将这些概念作为原文中的抽象概念进行处理和呈现，不得增删或解释其内涵。

## 法条引用（search_law 工具）

本节点已挂载 `search_law` 工具。当用户询问"哪条法律支撑这个结论"、"引用条款依据"、"对应法条"等需要法条出处的问题时，必须调用 `search_law` 工具检索具体法条全文，并将返回结果以「法律名称 + 条号 + 条文摘要」格式附在回答中作为依据。**禁止凭记忆背诵法条号**。', '[]', 'v1', 'system', 1, 6, '2026-03-23 11:27:41.069+08', '2026-03-23 11:33:57.956+08', NULL);
...
9. 在处理我的问题时，你必须严格遵循‘原文概念锁定’原则。
   ...
   - 你必须始终将它作为原文中的抽象概念进行分析。

## 法条引用（search_law 工具）

本节点已挂载 `search_law` 工具。当用户询问"哪条法律支撑这个结论"、"引用条款依据"、"对应法条"等需要法条出处的问题时，必须调用 `search_law` 工具检索具体法条全文，并将返回结果以「法律名称 + 条号 + 条文摘要」格式附在回答中作为依据。**禁止凭记忆背诵法条号**。', '[]', 'v1', 'system', 1, 7, '2026-03-23 11:28:47.378+08', '2026-03-23 11:33:56.331+08', NULL);
...
本节点已挂载 `search_law` 工具。当用户询问"哪条法律支撑这个结论"、"引用条款依据"、"对应法条"等需要法条出处的问题时，必须调用 `search_law` 工具检索具体法条全文，并将返回结果以「法律名称 + 条号 + 条文摘要」格式附在回答中作为依据。**禁止凭记忆背诵法条号**。', '[]', 'v1', 'system', 1, 8, '2026-03-23 11:29:33.105+08', '2026-03-23 11:33:53.988+08', NULL);
...
9. **强制输出规范**：输出内容必须以一级标题 `# 判决趋势预测` 开始，**一级标题之前不要输出任何内容。**

## 法条引用（search_law 工具）

本节点已挂载 `search_law` 工具。当用户询问"哪条法律支撑这个结论"、"引用条款依据"、"对应法条"等需要法条出处的问题时，必须调用 `search_law` 工具检索具体法条全文，并将返回结果以「法律名称 + 条号 + 条文摘要」格式附在回答中作为依据。**禁止凭记忆背诵法条号**。', '[]', 'v1', 'system', 1, 9, '2026-03-23 11:30:52.971+08', '2026-03-23 11:33:51.188+08', NULL);
...
本节点已挂载 `search_law` 工具。当用户询问"哪条法律支撑这个结论"、"引用条款依据"、"对应法条"等需要法条出处的问题时，必须调用 `search_law` 工具检索具体法条全文，并将返回结果以「法律名称 + 条号 + 条文摘要」格式附在回答中作为依据。**禁止凭记忆背诵法条号**。', '[]', 'v1', 'system', 1, 10, '2026-03-23 11:32:01.958+08', '2026-03-23 11:33:48.944+08', NULL);
...
> **重要提示**：为最大程度启发抗辩策略的梳理，本报告包含了一定程度的推演与发散性思考。所有内容仅供专业参考，请您务必结合案件具体情况，进行独立的专业判断与决策。

## 法条引用（search_law 工具）

本节点已挂载 `search_law` 工具。当用户询问"哪条法律支撑这个结论"、"引用条款依据"、"对应法条"等需要法条出处的问题时，必须调用 `search_law` 工具检索具体法条全文，并将返回结果以「法律名称 + 条号 + 条文摘要」格式附在回答中作为依据。**禁止凭记忆背诵法条号**。', '[]', 'v1', 'system', 1, 11, '2026-03-23 11:32:44.932+08', '2026-03-23 11:33:47.023+08', NULL);
...
本节点已挂载 `search_law` 工具。当用户询问"哪条法律支撑这个结论"、"引用条款依据"、"对应法条"等需要法条出处的问题时，必须调用 `search_law` 工具检索具体法条全文，并将返回结果以「法律名称 + 条号 + 条文摘要」格式附在回答中作为依据。**禁止凭记忆背诵法条号**。', '[]', 'v1', 'system', 1, 12, '2026-03-23 11:33:35.943+08', '2026-03-23 11:33:44.037+08', NULL);
