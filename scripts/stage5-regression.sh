#!/usr/bin/env bash
# 阶段 5 全量回归脚本
# 用途：AI 基建统一改造阶段 5（通用问答 → 文书 / 合同，无 caseId）收尾前一键验证
...
echo ""
echo "建议打 tag："
echo "  git tag -a ai-unify-stage-5-done -m '阶段 5 完成：通用问答 → 文书 / 合同（无 caseId）'"
